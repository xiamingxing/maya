// CityNpcTableSet.cpp : implementation file
//
...
IMPLEMENT_DYNAMIC(CCityNpcTableSet, CRecordset)

CCityNpcTableSet::CCityNpcTableSet(CDatabase* pdb)
	: CRecordset(pdb)
{
	//{{AFX_FIELD_INIT(CCityNpcTableSet)
	m_sSid = 0;
	m_sPid = 0;
	m_strName = _T("");
	m_sSTR = 0;
...
CString CCityNpcTableSet::GetDefaultConnect()
{
	return _T("ODBC;DSN=drgame;UID=drgame;PWD=drgame");
}

CString CCityNpcTableSet::GetDefaultSQL()
{
	return _T("[dbo].[NPC]");
}

void CCityNpcTableSet::DoFieldExchange(CFieldExchange* pFX)
{
	//{{AFX_FIELD_MAP(CCityNpcTableSet)
...
/////////////////////////////////////////////////////////////////////////////
// CCityNpcTableSet diagnostics

#ifdef _DEBUG
void CCityNpcTableSet::AssertValid() const
{
	CRecordset::AssertValid();
}

void CCityNpcTableSet::Dump(CDumpContext& dc) const
{
	CRecordset::Dump(dc);
}
#endif //_DEBUG
