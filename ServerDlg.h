...
public:
	...
	BOOL GetHuanshiTable();
	BOOL GetMESSAGETable();
	BOOL GetOnlineShopTable();
	BOOL GetKaixiangziTable();
	BOOL GetSxOnlineShopTable();
	BOOL GetOnlineRMBShopTable();//在线消耗器商店
...
public:
	afx_msg void OnBnClickedQuanout();//全下线按纽声明
};
